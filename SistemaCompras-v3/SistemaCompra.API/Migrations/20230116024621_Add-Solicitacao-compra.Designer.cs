...
namespace SistemaCompra.API.Migrations
{
    ...
    [Migration("20230116024621_Add-Solicitacao-compra")]
            ...
            modelBuilder.Entity("SistemaCompra.Domain.ProdutoAggregate.Produto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("76427e6f-8641-4b44-bd88-06d050f1ecf3"),
                            Categoria = 1,
                    ...
                    b.OwnsOne("SistemaCompra.Domain.Core.Model.Money", "Preco", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    ProdutoId = new Guid("76427e6f-8641-4b44-bd88-06d050f1ecf3"),
                                    Value = 100m
                                });
                        });
                });
